...
public class IntegerSliderBarActionListener implements ChangeListener {

    private IntegerSliderBarPanel panel;
     ...
     */
    public IntegerSliderBarActionListener(IntegerSliderBarPanel panel,String attrib) {
        this.panel = panel;
        attribute = attrib;
    }
