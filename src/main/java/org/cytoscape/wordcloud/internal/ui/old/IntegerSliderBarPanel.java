...
import org.cytoscape.wordcloud.internal.ui.prefuse.NumberRangeModel;
...
public class IntegerSliderBarPanel extends JPanel {
     ...
     * @param desired_width
     */
    public IntegerSliderBarPanel(double min, double max, String sliderLabel,String attrib, int desired_width) {
